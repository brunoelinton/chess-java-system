...
public class ChessMatch {
	...
	// RETURNS A MATRIX WITH THE POSSIBLE MOVEMENTS OF A PIECE
	...
	// PERFORM THE MOVEMENT OF THE PIECES
	...
	public ChessPiece replacePromotedPiece(String type) {
		...
		if(!type.equals("B") && !type.equals("N") && !type.equals("R") && !type.equals("Q")) {
			throw new InvalidParameterException("Invalid type fo promotion.");
		}
	...
	// AUXILIARY METHOD FOR THE PROMOTION OF THE PAWN
	...
	// AUXILIARY METHOD TO RETURN THE KING IN CHECK POSITION
	...
	// TESTS IF THERE IS A MATE CHECK
	...
	// INSERTS A PIECE INFORMING A POSITION ON THE BOARD. EX: 'A7'
